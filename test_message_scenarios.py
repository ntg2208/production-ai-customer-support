...
SESSION_2_REFUND_REBOOKING = [
    ...
    "Great! Now I need to book a new ticket for the same route but next Tuesday instead. Can you search for trains from London Euston to Manchester Piccadilly on August 5th? I'd like to see all the available options.",
    ...
    "That flexibility sounds perfect for my needs. Please book the 9:30 UK101 Flexible fare for August 5th. My email is sarah.williams@email.co.uk and I'll pay with my debit card.",
...
SESSION_10_COMPREHENSIVE_TEST = [
    ...
    "Let me keep that original booking for now. I need to book additional travel for next month. Can you search for trains from Manchester Piccadilly to London Euston on August 15th?",
    ...
    "Can you search specifically for first class tickets with wheelchair accessibility from Manchester Piccadilly to London Euston on August 15th morning?",
    ...
    "Perfect! Please book the UK202 first class service for August 15th with wheelchair accessibility noted. I'll pay with my corporate credit card.",
...
SESSION_12_YOUNG_PROFESSIONAL = [
    ...
    "work meeting tuesday august 5th",
